...
class SignalPlotWidget(PlotWidget):
    ...
    def plot(self, signal_name, frequency, sample_rate, amplitude=1, duration=1, x_scale_value = 1, 
    y_scale_value = 1, x_scale_type = 0, y_scale_type = 0, flag = 1, flag_slider = 0):
        self.clear()
        if flag == 1:
