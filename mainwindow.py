...
class MainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.ss_params_label = QLabel('Second signal')
        self.ss_toggle_button = QPushButton('Summation of signals', self)
        self.ss_toggle_button.setCheckable(True)
        self.ss_toggle_button.clicked.connect(self.set_signal)
        self.ss_toggle_button1 = QPushButton('Amplitude modulation', self)
        self.ss_toggle_button1.setCheckable(True)
        self.ss_toggle_button1.clicked.connect(self.set_signal1)
        self.ss_params_label.setBuddy(self.ss_toggle_button)
        self.ss_params_label.setBuddy(self.ss_toggle_button1)
        ...
        ss_switch_layout.addWidget(self.ss_params_label)
        ss_switch_layout.addWidget(self.ss_toggle_button)
        ss_switch_layout.addWidget(self.ss_toggle_button1)
    ...
    def set_signal1(self):
        if not (self.fs_toggle_button.isChecked() or self.ss_toggle_button1.isChecked()):
            self.signal_plot.clear()
            self.spectre_plot.clear()
            return
        ...
        if self.fs_toggle_button.isChecked() and self.ss_toggle_button1.isChecked():

            self.signal_plot.modulate(fs_frequency, fs_sample_rate, fs_duration, ss_amplitude, ss_frequency,
                                      fs_amplitude)

            self.spectre_plot.modulate(fs_frequency, fs_sample_rate, fs_duration, ss_amplitude, ss_frequency,
                                       fs_amplitude)

        elif self.ss_toggle_button1.isChecked():
